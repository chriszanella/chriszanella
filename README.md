...
Apaixonado por tecnologia, irei cursar **Engenharia de Software** eu tornar um **Fullstack Developer**. Estudo de forma autodidata, explorando tanto o front-end quanto o back-end para construir soluções completas e eficientes.
